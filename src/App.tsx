...
export default function App() {
  ...
  return (
    <main className="min-h-screen min-h-svh overflow-x-hidden bg-void text-slate-100">
      ...
      {game.started ? <GameBoard {...game} /> : <StartScreen onStart={game.start} voiceName={game.voiceName} setVoiceName={game.setVoiceName} />}
    </main>
  );
}
